...
running command...
$ space-cli (--version)
space-cli/0.0.0 win32-x64 node-v18.10.0
...
* [`space-cli help [COMMANDS]`](#space-cli-help-commands)
...
_See code: [dist/commands/hello/index.ts](https://github.com/ajbol/hello-world/blob/v0.0.0/dist/commands/hello/index.ts)_
...
## `space-cli help [COMMANDS]`

Display help for space-cli.

```
USAGE
  $ space-cli help [COMMANDS] [-n]
